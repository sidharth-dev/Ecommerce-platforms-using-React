...
function Home() {
  ...
  return (
    <>
      ...
      <div className={classNames("p2", " d-flex", "justify-content-around")}>
        <div classNames="row ">
          <div className="row px-3  d-flex justify-content-around ">
            <div className="offer-container-1 my-3">
              <div className="offer-title col-12">
                <h2>
                  <a>Beauty</a>
                </h2>
              </div>
              <div className="offer-card-container">
                <div className="offer-card">
                  <img src={offerProducts[2].thumbnail} className="offer-img" />

                  <h6>
                    Discount: {offerProducts[2].discountPercentage}% off
                    <br />
                    Price:{offerProducts[2].price}$
                  </h6>
                </div>
                <div className="offer-card">
                  {" "}
                  <img src={offerProducts[3].thumbnail} className="offer-img" />
                  <h6>
                    Discount: {offerProducts[3].discountPercentage}% off
                    <br />
                    Price:{offerProducts[3].price}$
                  </h6>
                </div>
                <div className="offer-card">
                  {" "}
                  <img src={offerProducts[4].thumbnail} className="offer-img" />
                  <h6>
                    Discount: {offerProducts[4].discountPercentage}% off
                    <br />
                    Price:{offerProducts[4].price}$
                  </h6>
                </div>
                <div className="offer-card">
                  {" "}
                  <img src={offerProducts[0].thumbnail} className="offer-img" />
                  <h6>
                    Discount: {offerProducts[0].discountPercentage}% off
                    <br />
                ...
                <div className="offer-card">
                  {" "}
                  <img src={offerProducts[1].thumbnail} className="offer-img" />
                  <h6>
                    Discount: {offerProducts[1].discountPercentage}% off
                    <br />
          ...
          <div className="row ">
            <div className="col-md-4">
              <div className="offer-container-2 my-3">
                <div className="offer-title col-12 p-1">
                  <h2>furniture</h2>
                </div>
                <div className="offer-card-container">
                  {" "}
                  <div className="offer-card">
                    {" "}
                    <img
                      src={offerProducts[11].thumbnail}
                      className="offer-img"
                    />
                    <h6>
                      Discount: {offerProducts[11].discountPercentage}% off
                      <br />
                      Price:{offerProducts[11].price}$
                    </h6>
                  </div>
                  <div className="offer-card">
                    {" "}
                    <img
                      src={offerProducts[12].thumbnail}
                      className="offer-img"
                    />
                    <h6>
                      Discount: {offerProducts[12].discountPercentage}% off
                      <br />
                      Price:{offerProducts[12].price}$
                    </h6>
                  </div>
                  <div className="offer-card">
                    {" "}
                    <img
                      src={offerProducts[13].thumbnail}
                      className="offer-img"
                    />
                    <h6>
                      Discount: {offerProducts[13].discountPercentage}% off
                      <br />
                      Price:{offerProducts[13].price}$
                    </h6>
                  </div>
                  <div className="offer-card">
                    {" "}
                    <img
                      src={offerProducts[14].thumbnail}
                      className="offer-img"
                    />
                    <h6>
                      Discount: {offerProducts[14].discountPercentage}% off
                      <br />
                      Price:{offerProducts[14].price}$
                    </h6>
                  </div>
                </div>
              </div>
              ...
              <div className="offer-container-2 my-3">
                ...
                <div className="offer-card-container">
                  <div className="offer-card">
                    {" "}
                    <img
                      src={offerProducts[6].thumbnail}
                      className="offer-img"
                    />
                    <h6>
                      Discount: {offerProducts[6].discountPercentage}% off
                      <br />
                      Price:{offerProducts[6].price}$
                    </h6>
                  </div>
                  <div className="offer-card">
                    {" "}
                    <img
                      src={offerProducts[7].thumbnail}
                      className="offer-img"
                    />
                    <h6>
                      Discount: {offerProducts[7].discountPercentage}% off
                      <br />
                      Price:{offerProducts[7].price}$
                    </h6>
                  </div>
                  <div className="offer-card">
                    {" "}
                    <img
                      src={offerProducts[8].thumbnail}
                      className="offer-img"
                    />
                    <h6>
                      Discount: {offerProducts[8].discountPercentage}% off
                      <br />
                      Price:{offerProducts[8].price}$
                    </h6>
                  </div>
                  <div className="offer-card">
                    {" "}
                    <img
                      src={offerProducts[9].thumbnail}
                      className="offer-img"
                    />
                    <h6>
                      Discount: {offerProducts[9].discountPercentage}% off
                      <br />
                      Price:{offerProducts[9].price}$
                    </h6>
                  </div>
                </div>
              </div>
            ...
            <div className="col-md-4">
              <div className="offer-container-2 my-3">
                ...
                <div className="offer-card-container">
                  <div className="offer-card">
                    <img
                      src={offerProducts[16].thumbnail}
                      className="offer-img"
                    />
                    <h6>
                      Discount: {offerProducts[16].discountPercentage}% off
                      <br />
                      Price:{offerProducts[16].price}$
                    </h6>
                  </div>
                  <div className="offer-card">
                    <img
                      src={offerProducts[17].thumbnail}
                      className="offer-img"
                    />
                    <h6>
                      Discount: {offerProducts[17].discountPercentage}% off
                      <br />
                      Price:{offerProducts[17].price}$
                    </h6>
                  </div>
                  <div className="offer-card">
                    <img
                      src={offerProducts[18].thumbnail}
                      className="offer-img"
                    />
                    <h6>
                      Discount: {offerProducts[18].discountPercentage}% off
                      <br />
                      Price:{offerProducts[18].price}$
                    </h6>
                  </div>
                  <div className="offer-card">
                    <img
                      src={offerProducts[19].thumbnail}
                      className="offer-img"
                    />
                    <h6>
                      Discount: {offerProducts[19].discountPercentage}% off
                      <br />
                      Price:{offerProducts[19].price}$
                    </h6>
                  </div>
                </div>
              </div>
